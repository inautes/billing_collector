    ...
    const sites = [
      {
        ...
        password: 'jaye1234!',
        loginSelector: 'form',
        usernameSelector: 'input[name="user_id"]',
        passwordSelector: 'input[type="password"]',
        submitSelector: 'input[type="image"]',
        settlementMenuSelector: 'a[href*="sales"]',
        datePickerSelector: 'input[name="sdate"]',
        searchButtonSelector: 'input[type="button"][value="검색"]',
        tableSelector: 'table',
